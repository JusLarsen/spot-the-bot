...
shuffled bank of 258 text samples — for each one the group decides **human** or **AI**.
...
258 samples across 9 categories, each mixing authentic human quotes with AI imitations:

| Category     | Count | Source flavor                                    |
| ------------ | ----- | ------------------------------------------------ |
| `movies`     | 46    | Star Wars / Avengers / Spaceballs lines          |
| `genx`       | 38    | Gen X comedies (Caddyshack, Ghostbusters, …)     |
| `bbq`        | 36    | Traeger influencers (Diva Q, Matt Pittman, …)    |
| `millennial` | 36    | Millennial comedies (Elf, Mean Girls, Zoolander) |
| `business`   | 27    | Business-book quotes + AI office replies         |
| `disney`     | 24    | Famous + obscure Disney/Pixar lines              |
| `speech`     | 20    | Famous / funny speeches                          |
| `alpha`      | 17    | Gen Alpha family films (Encanto, Paddington 2)   |
