...
shuffled bank of 150 text samples — for each one the group decides **human** or **AI**.
...
150 samples across 5 categories, each mixing authentic human quotes with AI imitations:
