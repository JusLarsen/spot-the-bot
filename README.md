...
shuffled bank of 152 text samples — for each one the group decides **human** or **AI**.
...
152 samples across 5 categories, each mixing authentic human quotes with AI imitations:

| Category   | Count | Source flavor                                 |
| ---------- | ----- | --------------------------------------------- |
| `movies`   | 48    | Star Wars / Avengers / Spaceballs lines       |
| `bbq`      | 40    | Traeger influencers (Diva Q, Matt Pittman, …) |
| `business` | 24    | Business-book quotes                          |
