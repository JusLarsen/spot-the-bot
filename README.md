...
shuffled bank of 246 text samples — for each one the group decides **human** or **AI**.
...
246 samples across 9 categories, each mixing authentic human quotes with AI imitations:

| Category     | Count | Source flavor                                    |
| ------------ | ----- | ------------------------------------------------ |
| `movies`     | 48    | Star Wars / Avengers / Spaceballs lines          |
| `bbq`        | 38    | Traeger influencers (Diva Q, Matt Pittman, …)    |
| `genx`       | 35    | Gen X comedies (Caddyshack, Ghostbusters, …)     |
| `millennial` | 35    | Millennial comedies (Elf, Mean Girls, Zoolander) |
| `disney`     | 24    | Famous + obscure Disney/Pixar lines              |
| `business`   | 22    | Business-book quotes                             |
| `genz`       | 18    | Gen Z comedies (Spider-Verse, Booksmart, …)      |
| `speech`     | 16    | Famous / funny speeches                          |
| `alpha`      | 10    | Gen Alpha family films (Encanto, Paddington 2)   |
...
Every AI sample in the cohort categories carries one **real, transferable AI tic** — the
"In today's world" opener, lists of three, `delve`/`tapestry`, hedge-everything, the tidy
uplifting closer. The joke and the lesson are the same thing: a machine tic dropped into a
comedy scene is funny _and_ teaches something players will meet in a real AI-written email.
