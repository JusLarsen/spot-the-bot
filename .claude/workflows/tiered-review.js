export const meta = {
  name: "tiered-review",
  description:
    "Risk-gated tiered code review: isolated Sonnet quorum (report-everything) → higher-tier (Opus/Fable) adjudication before merge",
  phases: [
    ...
    {
      title: "Adjudicate",
      detail: "Opus/Fable dedups, converges, hunts blind spots, gives the merge verdict",
    },
  ],
};
